...
class DataBase  {
 ...
 public function where_union ($tabla,$where = null,$tablau,$whereu = null,$columnas = null,$limit = null){
   ...
   public function insert($table = null , $arrDatos = array()){
       if(is_null($table) == true)  throw new Exception('No existen tabla para ingresar');
       if(sizeof($arrDatos) == 0)  throw new Exception('No existen datos para ingresar');
       $coma = '';
       $Cols = "";
       $binds  = "";
       $cont = 1 ; 
